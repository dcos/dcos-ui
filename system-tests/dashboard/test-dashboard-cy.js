...
const {
  createService,
  createNonRunningService,
  deleteService
} = require("../_support/index");
...
const serviceRunningDefinition = {
  id: `/${Cypress.env("TEST_UUID")}/running`,
  instances: 1,
  portDefinitions: [],
  container: {
    docker: {
...
const serviceDelayedDefinition = {
  id: `/${Cypress.env("TEST_UUID")}/delayed`,
  instances: 1,
  portDefinitions: [],
  container: {
    docker: {
...
const serviceStoppedDefinition = {
  id: `/${Cypress.env("TEST_UUID")}/stopped`,
  instances: 0,
  portDefinitions: [],
  container: {
    docker: {
