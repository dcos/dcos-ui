...
To keep our tools sharp we need to make sure they work all the time. Therefore we use [bats](https://github.com/sstephenson/bats) to test our tooling.
On OSX install it with homebrew: `brew install bats`
