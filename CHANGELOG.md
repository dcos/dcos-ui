...
<a name="1.24.0"></a>
# [1.24.0](https://github.com/dcos/dcos-ui/compare/v1.11.1...v1.24.0) (2018-10-17)
...
* **FrameworkConfigurationForm:** truncate labels instead of overflowing ([2c21349](https://github.com/dcos/dcos-ui/commit/2c21349))
* **frameworkform:** fix framework form to work with all jsons ([9e09265](https://github.com/dcos/dcos-ui/commit/9e09265))
* **FuzzyTextDSLSection:** apply changes in fuzzy search directly ([f704c10](https://github.com/dcos/dcos-ui/commit/f704c10))
* **JSONReducer:** don't swallow container fields added in JSON editor ([2b044d9](https://github.com/dcos/dcos-ui/commit/2b044d9))
* **marathonUtil:** fix parsePod function ([d4373f5](https://github.com/dcos/dcos-ui/commit/d4373f5))
* **MesosLog:** show error when logs can not be loaded ([cf7d6a3](https://github.com/dcos/dcos-ui/commit/cf7d6a3))
...
* **PodInstancesTable:** clarify resource totals on pod instances table ([742a97d](https://github.com/dcos/dcos-ui/commit/742a97d))
* **scrollbar:** fix scrolling ([41560b3](https://github.com/dcos/dcos-ui/commit/41560b3))
...
* **Services:** environment labels show error ([e11813e](https://github.com/dcos/dcos-ui/commit/e11813e))
...
* **TasksTable-cy:** fix tasks table integration tests ([371f2b1](https://github.com/dcos/dcos-ui/commit/371f2b1))
...
* guard against invalid schema ([b9d0cc6](https://github.com/dcos/dcos-ui/commit/b9d0cc6))
...
* **ServiceForm:** add error for environment values without keys ([40e2e5e](https://github.com/dcos/dcos-ui/commit/40e2e5e))
* **StringUtil:** filterByString now sorts by search relevance ([f337dea](https://github.com/dcos/dcos-ui/commit/f337dea))
* **UniversePackagesList:** When filtering by text, rank certified first ([218dff7](https://github.com/dcos/dcos-ui/commit/218dff7))
...
<a name="1.23.0"></a>
# [1.23.0](https://github.com/dcos/dcos-ui/compare/v1.11.1...v1.23.0) (2018-09-19)
