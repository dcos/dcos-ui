  ...
  context("SDK Groups", function() {
    ...
    context("Create groups modal", function() {
      ...
      context("Fullscreen group modal", function() {
        ...
        context("Edit modal", function() {
          beforeEach(function() {
            cy.visitUrl({ url: "/services/overview" });
            openDropdown("services");
          });

          it("shows edit action for top-level groups", function() {
            cy.get(".dropdown-menu-items li")
              .contains("Edit")
              .should("exist");
          });

          it("opens the edit modal", function() {
          ...
          it("shows the correct id and the input is disabled", function() {
            clickDropdownAction("Edit");
            getInput("id")
          ...
          it("shows the correct path", function() {
            clickDropdownAction("Edit");
            cy.get("div")
              .contains("/services")
              .should("exist");
          ...
          it("shows the correct Quota inputs", function() {
            clickDropdownAction("Edit");
            getInput("quota.cpus").should("exist");
            getInput("quota.mem").should("exist");
            getInput("quota.disk").should("exist");
          ...
          it("allows Quota values to be changed", function() {
            clickDropdownAction("Edit");
      ...
      context("Small group modal", function() {
        ...
        it("does not show the edit action for non-top-level groups", function() {
