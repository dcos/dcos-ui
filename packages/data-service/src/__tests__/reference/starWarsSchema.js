// source https://github.com/graphql/graphql-js/blob/master/src/__tests__/starWarsSchema.js
/**
...
const characterInterface = new GraphQLInterfaceType({
  ...
  fields: () => ({
    ...
    friends: {
      ...
      description: "The friends of the character, or an empty list."
    },
    appearsIn: {
...
const queryType = new GraphQLObjectType({
  ...
  fields: () => ({
    hero: {
      ...
      resolve: (root, { episode }) => Observable.of(getHero(episode))
    },
    human: {
      type: humanType,
      args: {
      ...
      resolve: (root, { id }) => Observable.of(getHuman(id))
    },
    droid: {
      type: droidType,
      args: {
      ...
      resolve: (root, { id }) => Observable.of(getDroid(id))
    }
  })
});
