...
export const REQUEST_VERSIONS_ERROR = "REQUEST_VERSIONS_ERROR";
export const REQUEST_VERSIONS_SUCCESS = "REQUEST_VERSIONS_SUCCESS";
...
export const LANGUAGE_MODAL_ACTION = "LANGUAGE_MODAL_ACTION";
