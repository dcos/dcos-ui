...
const UnitSummaries = {
  "dcos-marathon.service": {
    summary: `The ${Config.productName} Marathon instance starts and monitors ${
      Config.productName
  ...
  "dcos-signal.service": {
    summary: `Sends a periodic ping back to Mesosphere with high-level cluster information to help improve ${
      Config.productName
  ...
  "dcos-history-service.service": {
    summary: `Caches recent cluster history in-memory so that the ${
      Config.productName
  ...
  "dcos-download.service": {
    summary: `Downloads and extracts the ${
      Config.productName
