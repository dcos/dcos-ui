...
const ListenersDescription = {
  ...
  metronome: {
    ...
    events: {
      ...
      jobDisableScheduleError: METRONOME_JOB_DISABLE_SCHEDULE_ERROR,
      jobDisableScheduleSuccess: METRONOME_JOB_DISABLE_SCHEDULE_SUCCESS,
      jobEnableScheduleError: METRONOME_JOB_ENABLE_SCHEDULE_ERROR,
      jobEnableScheduleSuccess: METRONOME_JOB_ENABLE_SCHEDULE_SUCCESS,
