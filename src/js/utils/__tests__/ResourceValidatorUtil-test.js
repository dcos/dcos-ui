...
describe('ResourceValidatorUtil', function () {
  ...
  describe('#isValidCPUSValue', function () {
    ...
    it('should properly handle wrong value types', function () {
      expect(ResourceValidatorUtil.isValidCPUs('not a number 666'))
        .toBe(false);
    });
  ...
  describe('#isValidDiskValue', function () {
    ...
    it('should properly handle wrong value types', function () {
      expect(ResourceValidatorUtil.isValidDisk('not a number 666'))
        .toBe(false);
    });
  ...
  describe('#isValidMemoryValue', function () {
    ...
    it('should properly handle wrong value types', function () {
      expect(ResourceValidatorUtil.isValidMemory('not a number 666'))
        .toBe(false);
    });
