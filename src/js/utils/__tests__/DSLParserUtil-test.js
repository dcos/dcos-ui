...
describe('DSLParserUtil', function () {
  ...
  describe('#Operator.attribute', function () {
    ...
    beforeEach(function () {
      this.op = DSLParserUtil.Operator.attribute(
        'label', 'text', 0, 5, 10, 20
      );
    });
  ...
  describe('#Operator.exact', function () {
    ...
    beforeEach(function () {
      this.op = DSLParserUtil.Operator.exact(
        'text', 0, 10
      );
    });
  ...
  describe('#Operator.fuzzy', function () {
    ...
    beforeEach(function () {
      this.op = DSLParserUtil.Operator.fuzzy(
        'text', 0, 10
      );
    });
  ...
  describe('#Merge.and', function () {
    ...
    beforeEach(function () {
      ...
      this.opRight = DSLParserUtil.Operator.fuzzy(
        'text', 21, 30
      );
