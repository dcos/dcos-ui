...
module.exports = {
  ...
  getObjectInformation(source) {
    ...
    // Get the javascript model for easier processing
    try {
      ...
      for (let i=0, l=source.length; i<l; ) {
        ...
        // Keep current position and forward to next token
        let curr = i;
      ...
      // Convert all exceptions to syntax errors
      throw SyntaxError(`Parsing error: ${e.toString()}`);
