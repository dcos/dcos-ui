...
class ConfigurationView extends mixin(StoreMixin) {
  ...
  getDockerContainerSection({container}) {
    ...
    let headerValueMapping = {
      ...
      'Parameters': StringUtil.arrayToCommaSeparatedString(docker.parameters),
        ...
        switch (healthCheck.protocol) {
          ...
          case 'HTTP':
            headerValueMapping = Object.assign(headerValueMapping, {
              ...
              'Port Index': healthCheck.portIndex || 'PORT_INDEX',
              'Port Type': healthCheck.portType,
  ...
  getOtherSection(config) {
    let headerValueMapping = {
      'Constraints': StringUtil.arrayToCommaSeparatedString(config.constraints),
      'Dependencies': StringUtil.arrayToCommaSeparatedString(config.dependencies),
      'Resource Roles': StringUtil.arrayToCommaSeparatedString(config.acceptedResourceRoles),
      ...
      'URIs': StringUtil.arrayToCommaSeparatedString(config.uris),
      'User': config.user,
      'Args': StringUtil.arrayToCommaSeparatedString(config.args),
