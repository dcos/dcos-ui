...
describe('TabButton', function () {
  ...
  it('should call the onClick prop with ID when clicked', function () {
    ...
    TestUtils.Simulate.click(ReactDOM.findDOMNode(this.instance).querySelector('.menu-tabbed-item-label'));
  ...
  it('should call the parent onClick when clicking a nested TabButton', function () {
    ...
    // Click the TabButton's label
    TestUtils.Simulate.click(ReactDOM.findDOMNode(this.instance).querySelector('.menu-tabbed-item .menu-tabbed-item .menu-tabbed-item-label'));
