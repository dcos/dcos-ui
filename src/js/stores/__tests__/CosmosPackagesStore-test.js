...
describe("CosmosPackagesStore", function() {
  ...
  describe("#fetchServiceDescription", function() {
    ...
    it("should return an instance of UniversePackage within response", function() {
      CosmosPackagesStore.fetchServiceDescription("foo");
      var response = CosmosPackagesStore.getServiceDetails();
      var serviceDetails = new UniversePackage(response.package);
    ...
    it("should return the packageDetails it was given", function() {
      ...
      expect(serviceDetails.getName()).toEqual(
        this.serviceDescribeFixture.package.name
      );
      expect(serviceDetails.getVersion()).toEqual(
        this.serviceDescribeFixture.package.version
      );
    });
