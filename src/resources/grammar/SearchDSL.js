...
import DSLParserUtil from "../../js/utils/DSLParserUtil";
...
const SearchDSL = (() => {
  ...
  const parser = {
    ...
    performAction: function anonymous(
      ...
      switch (yystate) {
        ...
        case 9:
          ...
          break;
        case 10:
          this.$ = $$[$0].reduce((last_fn, v) => {
            const fn = Operator.attribute(
              $$[$0 - 1],
              v.text,
              _$[$0 - 1].first_column,
              _$[$0 - 1].last_column,
    ...
    table: [
      { 3: 1, 4: 2, 7: $V0, 8: $V1, 12: $V2, 14: $V3 },
      { 1: [3] },
      { 5: [1, 7], 10: $V4, 11: $V5 },
      { 4: 10, 7: $V0, 8: $V1, 12: $V2, 14: $V3 },
      o($V6, [2, 8]),
      o($V6, [2, 9]),
      o($V6, [2, 11], { 6: 11, 7: $V7, 8: $V8 }),
      { 1: [2, 1] },
      { 4: 14, 7: $V0, 8: $V1, 12: $V2, 14: $V3 },
      { 4: 15, 7: $V0, 8: $V1, 12: $V2, 14: $V3 },
      { 10: $V4, 11: $V5, 13: [1, 16] },
      o($V6, [2, 10], { 9: [1, 17] }),
      o($V9, [2, 2]),
      o($V9, [2, 3]),
