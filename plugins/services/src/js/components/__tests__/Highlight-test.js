...
describe("Highlight instance", function() {
  ...
  it("support custom HTML tag for matching elements", function() {
    var instance = ReactDOM.render(
  ...
  it("support custom className for matching element", function() {
    var instance = ReactDOM.render(
  ...
  it("support passing props to parent element", function() {
    var instance = ReactDOM.render(
  ...
  it("support regular expressions in search", function() {
    var instance = ReactDOM.render(
  ...
  it("support escaping arbitrary string in search", function() {
