...
describe("ConfigurationMapSizeValue", function() {
  it("assume default MB scale", function() {
  ...
  it("correctly handle `scale` property", function() {
    var instance = TestUtils.renderIntoDocument(
  ...
  it("correctly pass down to Units.filesize the `decimals`", function() {
    var instance = TestUtils.renderIntoDocument(
  ...
  it("correctly pass down to Units.filesize the `multiplier`", function() {
    var instance = TestUtils.renderIntoDocument(
  ...
  it("correctly pass down to Units.filesize the `threshold`", function() {
    var instance = TestUtils.renderIntoDocument(
  ...
  it("correctly pass down to Units.filesize the `units`", function() {
    var instance = TestUtils.renderIntoDocument(
  ...
  it("correctly render `defaultValue` if empty", function() {
    var instance = TestUtils.renderIntoDocument(
