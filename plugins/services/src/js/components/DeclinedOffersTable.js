  ...
  render() {
    ...
    return (
      <MountService.Mount type="DeclinedOffersTable">
        <Table
          className="table table-simple table-flush table-borderless-outer table-borderless-inner-columns table-header-nowrap table-break-word table-hover flush-bottom"
