...
class MultiContainerEnvironmentFormSection extends Component {
  ...
  render() {
    ...
    return (
      <div className="form flush-bottom">
        ...
        <MountService.Mount
          type="CreateService:MultiContainerEnvironmentFormSection"
          data={data}
          errors={errors}
...
MultiContainerEnvironmentFormSection.defaultProps = {
  data: {},
  errors: {},
  onAddItem() {},
  onRemoveItem() {}
...
MultiContainerEnvironmentFormSection.propTypes = {
...
MultiContainerEnvironmentFormSection.configReducers = {
  env,
  labels
};

module.exports = MultiContainerEnvironmentFormSection;
