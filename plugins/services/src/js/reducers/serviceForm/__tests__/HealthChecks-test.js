...
describe('Labels', function () {
  describe('#JSONReducer', function () {
    it('should return an Array', function () {
      let batch = new Batch();
      batch.add(new Transaction(['healthChecks'], 0, ADD_ITEM));
    ...
    it('should set the protocol', function () {
      ...
      // batch.add(new Transaction(['healthChecks', 0, 'value'], 'value'));
    ...
    it('should set the right Command', function () {
      ...
      batch.add(new Transaction(['healthChecks'], 0, ADD_ITEM));
      batch.add(new Transaction(['healthChecks', 0, 'protocol'], 'COMMAND'));
      batch.add(new Transaction(['healthChecks', 0, 'command'], 'sleep 1000;'));
    ...
    it('should set the right path', function () {
      ...
      batch.add(new Transaction(['healthChecks', 0, 'path'], '/test'));
    ...
    it('should have a fully fledged health check object', function () {
      ...
      batch.add(new Transaction(['healthChecks'], 0, ADD_ITEM));
      batch.add(new Transaction(['healthChecks', 0, 'protocol'], 'HTTP'));
      batch.add(new Transaction(['healthChecks', 0, 'https'], true));
      batch.add(new Transaction(['healthChecks', 0, 'path'], '/test'));
      batch.add(new Transaction(['healthChecks', 0, 'gracePeriodSeconds'], 1));
    ...
    it('should remove the right item', function () {
      ...
      batch.add(new Transaction(['healthChecks', 1, 'path'], '/test'));
      batch.add(new Transaction(['healthChecks'], 0, REMOVE_ITEM));
