...
describe("PodInstancesTable", function() {
  ...
  describe("#render", function() {
    ...
    describe("collapsed table", function() {
      ...
      it("properly render the name column", function() {
      ...
      it("properly render the address column", function() {
        var names = TestUtils.scryRenderedDOMComponentsWithClass(
          this.instance,
      ...
      it("properly render the status column", function() {
        var names = TestUtils.scryRenderedDOMComponentsWithClass(
          this.instance,
      ...
      it("properly render the cpu column", function() {
        var names = TestUtils.scryRenderedDOMComponentsWithClass(
          this.instance,
      ...
      it("properly render the mem column", function() {
        var names = TestUtils.scryRenderedDOMComponentsWithClass(
          this.instance,
      ...
      it("properly render the updated column", function() {
        var names = TestUtils.scryRenderedDOMComponentsWithClass(
          this.instance,
      ...
      it("properly render the version column", function() {
        var names = TestUtils.scryRenderedDOMComponentsWithClass(
          this.instance,
    ...
    describe("collapsed table, sorted ascending by name", function() {
      ...
      it("properly sort the name column", function() {
        var names = TestUtils.scryRenderedDOMComponentsWithClass(
          this.instance,
          "task-table-column-primary"
        ).reduce(
