...
describe("ServicesTable", function() {
  ...
  describe("#renderStats", function() {
    it("render resources/stats cpus property", function() {
    ...
    it("render resources/stats mem property", function() {
    ...
    it("render resources/stats disk property", function() {
    ...
    it("render sum of resources/stats cpus property", function() {
    ...
    it("render sum of resources/stats mem property", function() {
      const application = new Application({
        healthChecks: [{ path: "", protocol: "HTTP" }],
        cpus: 1,
        instances: 2,
    ...
    it("render sum of resources/stats disk property", function() {
      const application = new Application({
        healthChecks: [{ path: "", protocol: "HTTP" }],
        cpus: 1,
        instances: 2,
